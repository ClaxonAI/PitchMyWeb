...
export const metadata: Metadata = pageMetadata({
  path: "/contact",
  title: "Contact",
  description: `Questions about batches, pitching or billing? Email ${siteConfig.email} or send us a message — we reply within one working day.`,
});
...
export default function ContactPage() {
  return (
    <>
      <JsonLd schema={simplePageSchema("Contact", "/contact", "ContactPage")} />
