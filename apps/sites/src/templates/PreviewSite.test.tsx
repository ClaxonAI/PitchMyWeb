...
const DESIGN_ROOT: Record<string, string> = {
  ...
  "gym/editorial": "gym-poster",
  "gym/atelier": "gym-club",
  "interiors/editorial": "interiors-folio",
  "interiors/atelier": "interiors-library",
  "event/editorial": "event-invite",
  "event/atelier": "event-gala",
  "coaching/editorial": "coaching-notebook",
  "coaching/atelier": "coaching-crest",
